    ...
    <>
      ...
      <div className='mt-[-4em] ml-24  '>
        <div className="grid grid-cols-3 gap-8 p-6 lg:px-32 md:px-8 ">
          <Link href="/components/cs/cscourse" class="flex px-8 p-4 flex-col items-center bg-white   border h-20 border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-200 ">
          ...
          <Link href="/components/ITs/itcourse" class="flex px-8 p-4 flex-col items-center bg-gray-100 border h-20 border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-200 ">
          ...
          <Link href='/components/gis/giscourse' className='flex px-8 p-4 flex-col items-center bg-gray-100 border h-20 border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-200 '>
